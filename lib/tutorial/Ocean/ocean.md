...
1. Download the pretrained [PyTorch model](https://drive.google.com/drive/folders/1JqmeAmV8UxLMSPzi-72amZAjyPa4dfFJ?usp=sharing) and [TensorRT model](https://drive.google.com/drive/folders/1HhoilA14rucTOstEw7rBkYkv3UhCgzWT?usp=sharing) to `$TracKit/snapshot`.
2. Download [json](https://drive.google.com/drive/folders/17RkALMRkJCR6rcU--IV9Y1XQB-8GvBTU?usp=sharing) files of testing data and put them in `$TracKit/dataset`.
...
Please download the pretrained model on ImageNet [here](https://drive.google.com/drive/folders/1-lk5K3Dg7f4ZCJv3IzjCrILtIkiCC2so?usp=sharing), and then put it in `$TracKit/pretrain`.
